-- created_at/updated_at use NOW() (not a fixed past date) so this row stays within the
-- default stale-run-timeout window and is treated as genuinely active, not reaped.
