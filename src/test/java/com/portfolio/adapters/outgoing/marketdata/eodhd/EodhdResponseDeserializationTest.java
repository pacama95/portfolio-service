...
class EodhdResponseDeserializationTest {
    ...
    @Test
    void givenInvalidDecimal_whenDeserialized_thenBecomesMissingForTypedAdapterValidation() throws Exception {
        EodhdRealTimeResponse response = objectMapper.readValue(
